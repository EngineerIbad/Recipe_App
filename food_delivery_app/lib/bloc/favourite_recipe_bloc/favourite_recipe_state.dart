...
class RemoveRecipeFromFavourieLoadingState extends RecipeRemovedFromFavouriteState{}
class RemoveRecipeFromFavourieSuccessState extends RecipeRemovedFromFavouriteState{
  Recipe recipe;
  RemoveRecipeFromFavourieSuccessState({required this.recipe});
}
class RemoveRecipeFromFavourieFailedState extends RecipeRemovedFromFavouriteState{}


// Get All Favourite Recipes From Local DB
class GetAllFavouriteRecipesFromLocalDBInitialState extends FavouriteRecipeState {}
class GetAllFavouriteRecipesFromLocalDBSuccessState extends FavouriteRecipeState {}
class GetAllFavouriteRecipesFromLocalDBELoadingState extends FavouriteRecipeState {}
class GetAllFavouriteRecipesFromLocalDBErrorState extends FavouriteRecipeState {}